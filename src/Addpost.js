...
/>  */}
{/* cloudinary codes */}
<input type="file"id="btnImg"  onChange={ uploadPrev} onClick={handleEmtyInput}></input>
...
<p onClick={uploadImage}>Aceppt image</p>
<p onClick={uploadVid}>Aceppt video</p>
</form>
</div>
)
});
