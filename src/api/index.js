...
const API = setup({
  ...
  baseURL: 'https://hookbackengine-ruby.vercel.app/',
  
  cache: {
   
    maxAge: 35 * 60 * 1000, // 2 min instead of 15 min
    exclude: { query: true }
  }
});
...
export const fetchPosts2 = async ({ pageParam = 1 }) => {
   const response = await fetch(
       `https://hookbackengine-ruby.vercel.app/posts?page=${pageParam}&limit=8`,
